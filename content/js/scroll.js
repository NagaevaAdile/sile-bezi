    ...
    if(this.childElements.length > 0){
      this.childElements.forEach(child => {
        ...
        if(childRect.y <= this.halfViewHeight && childRect.bottom >= this.halfViewHeight){
          /*
          document.body.classList.toggle(childAttr);
          document.getElementById("change_color_page").className = ('change_color_page ' + childAttr); 


*/

          if(defaultChildAttr != childAttr){
            defaultChildAttr = childAttr;
            console.log(defaultChildAttr)
            console.log(childAttr)

           // document.body.className(childAttr);
            document.body.className = document.body.className =childAttr;
...
var scroller2 = new SmoothScroll({
  // scrollBody: document.querySelector(".scroll-content"),
  // scrollSpacer: document.querySelector(".spacer"),
  target: document.querySelector(".scroll-container"), // element container to scroll
  scrollEase: 0.05,
  horizontalScrollWrapper: document.querySelector(".horizontal-scroll-wrapper2"),
  horizontalScrollTarget: document.querySelector(".horizontal-scroll2")
});
